...
<div className="col-xxl-8 col-lg-8 col-10  d-flex justify-content-end">
    <nav className={`main-nav mr-2 ${MobileMenu?'slidenav':''} `}>
        <div className="inner-logo d-xl-none text-center pt-4">
            <Link legacyBehavior href="/"><a className="for-dark"><img src="/images/logo.png" alt=""/></a></Link>
        ...
        <ul>
            <li className="has-child-menu">
                ...
                data-height="100px"
                >
                    <li><Link legacyBehavior href="/"><a>Home Style - 01</a></Link></li>
                    <li><Link legacyBehavior href="/home-2"><a>Home Style - 02</a></Link></li>
                    <li><Link legacyBehavior href="/home-3"><a>Home Style - 03</a></Link></li>
                </ul>
            </li>
            <li className="has-child-menu">
                <a>Explore</a>
                ...
                data-height="150px"
                >
                    <li><Link legacyBehavior href="/marketplace-1"><a>Marketplace - 1</a></Link></li>
                    <li><Link legacyBehavior href="/marketplace-2"><a>Marketplace - 2</a></Link></li>
                    <li><Link legacyBehavior href="/live-auction"><a>Live Auction</a></Link></li>
                    <li><Link legacyBehavior href="/collection"><a>Collection</a></Link></li>
                </ul>
            </li>
            <li className="has-child-menu">
                <a>Pages</a>
                ...
                >
                    ...
                    <li><Link legacyBehavior href="/live-auction"><a>Live Auction</a></Link></li>
                    <li><Link legacyBehavior href="/collection"><a>Collection</a></Link></li>
                    <li><Link legacyBehavior href="/activity"><a>Activity</a></Link></li>
                    <li><Link legacyBehavior href="/connect-wallet"><a>Connect Wallet</a></Link></li>
                    <li><Link legacyBehavior href="/nft-detail"><a>NFT Details</a></Link></li>
                    <li><Link legacyBehavior href="/author-profile"><a>Author Profile</a></Link></li>
                    <li><Link legacyBehavior href="/login"><a>Login</a></Link></li>
                    <li><Link legacyBehavior href="/register"><a>Register</a></Link></li>
                </ul>
            </li>
            <li className="has-child-menu">
                <a>Create</a>
                ...
                data-height="150px"
                >
                    <li><Link legacyBehavior href="/create-nft"><a>Create NFT</a></Link></li>
                    <li><Link legacyBehavior href="/create-multiple-nft"><a>Create NFT (Maltiple)</a></Link></li>
                    <li><Link legacyBehavior href="/create-single-nft"><a>Create NFT (Single)</a></Link></li>
                    <li><Link legacyBehavior href="/"><a>Creators</a></Link></li>
                </ul>
            </li>
            <li className="has-child-menu">
                <a>Blog</a>
                ...
                data-height="80px"
                >
                    <li><Link legacyBehavior href="/blog"><a>Blog Grid</a></Link></li>
