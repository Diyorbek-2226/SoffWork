                ...
                <ul>
                    ...
                    <li className="has-child-menu">
                        ...
                        >
                            ...
                            <li><Link legacyBehavior href="/nft-details"><a>NFT Details</a></Link></li>
                    ...
                    <li className="has-child-menu">
                        ...
                        >
                            ...
                            <li><Link legacyBehavior href="/careate-multiple-nft"><a>Create NFT (Maltiple)</a></Link></li>
                            <li><Link legacyBehavior href="/create-single-nft"><a>Create NFT (Single)</a></Link></li>
                            <li><Link legacyBehavior href="/creators"><a>Creators</a></Link></li>
                        </ul>
                    </li>
                    <li className="has-child-menu">
                        <a>Blog</a>
