...
<div className="col-lg-3 col-6 d-flex justify-content-lg-center">
    <div className="footer__widget varient-2">
        ...
        <ul className="footer_widget__links">
            <li><Link legacyBehavior  href="/author-profile"><a>Profile</a></Link></li>
            <li><Link legacyBehavior  href="/marketplace-1"><a>Marketplace</a></Link></li>
            <li><Link legacyBehavior  href="/creators"><a>Creators</a></Link></li>
            <li><Link legacyBehavior  href="/activity"><a>Activity</a></Link></li>
            <li><Link legacyBehavior  href="/collection"><a>Colletctions</a></Link></li>
        </ul>
    </div>
</div>
<div className="col-lg-2 col-6 d-flex justify-content-lg-center ">
    <div className="footer__widget varient-2">
        ...
        <ul className="footer_widget__links">
            <li><Link legacyBehavior  href="/create-nft"><a>Upload</a></Link></li>
            <li><Link legacyBehavior  href="/connect-wallet"><a>Connect wallet</a></Link></li>
            <li><Link legacyBehavior  href="/blog"><a>Our blog </a></Link></li>
            <li><Link legacyBehavior  href="/nft-detail"><a>Item details</a></Link></li>
...
<div className="col-lg-4">
    <div className="footer__widget newslatter__widget">
        ...
        <ul className="footer_social__links d-flex style__three">
            <li><Link legacyBehavior  href={FooterConstant.SocialLinks.twitter}><a><i className="bi bi-twitter"></i></a></Link></li>
            <li><Link legacyBehavior  href={FooterConstant.SocialLinks.instagram}><a><i className="bi bi-instagram"></i></a></Link></li>
            <li><Link legacyBehavior  href={FooterConstant.SocialLinks.youtube}><a><i className="bi bi-youtube"></i></a></Link></li>
            <li><Link legacyBehavior  href={FooterConstant.SocialLinks.github}><a><i className="bi bi-github"></i></a></Link></li>
            <li><Link legacyBehavior  href={FooterConstant.SocialLinks.discord}><a><i className="bi bi-discord"></i></a></Link></li>
        </ul>
    </div>
</div>
</div>
...
<div className="col-lg-12">
    <p className="text-center">
        ...
        <Link legacyBehavior  href={FooterConstant.CopyRightLink.link}>
