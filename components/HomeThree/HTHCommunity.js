    ...
    <div className="col-lg-6 text-center">
        ...
        <p className="disc-text pt-2">Learn more about Maker, chat with the team, others in the community,
            ...
            <ul className="community_social__links d-flex flex-wrap justify-content-center">
                <li><Link legacyBehavior  href="/"><a><i className="bi bi-twitter"></i></a></Link></li>
                <li><Link legacyBehavior  href="/"><a><i className="bi bi-linkedin"></i></a></Link></li>
                <li><Link legacyBehavior  href="/"><a><i className="bi bi-youtube"></i></a></Link></li>
                <li><Link legacyBehavior  href="/"><a><i className="bi bi-github"></i></a></Link></li>
                <li><Link legacyBehavior  href="/"><a><i className="bi bi-discord"></i></a></Link></li>
            </ul>
    </div>
</div>
