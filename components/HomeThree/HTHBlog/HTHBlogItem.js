...
<div className="blog_card_style__one">
    <div className="blog__body">
        <div className="blog_thumb">
            <Link legacyBehavior  href="/blog"><img src={props.image} alt=""/></Link>
        </div>
        <div className="blog_disc">
            <ul className="blog_meta">
                <li className="blog__tag"> <Link legacyBehavior  href="/"><a>{props.category}</a></Link> </li>
                <li className="blog__writer"><Link legacyBehavior  href="/"><a>{props.author}</a></Link></li>
