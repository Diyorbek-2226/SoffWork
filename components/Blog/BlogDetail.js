        ...
        <div className="blog__bottom">
            <div className="d-flex align-content-center justify-content-between flex-wrap">
                <ul className="blog__tags">
                    <li><Link legacyBehavior href="/blog"><a>NFT</a></Link></li>
                    <li><Link legacyBehavior href="/blog"><a>Creative</a></Link></li>
                    <li><Link legacyBehavior href="/blog"><a>Crypto</a></Link></li>
                    <li><Link legacyBehavior href="/blog"><a>Software</a></Link></li>
                    <li><Link legacyBehavior href="/blog"><a>Art</a></Link></li>
                </ul>
                <div className="blog__share d-flex align-items-center">
                    <span>ShareThis :</span>
                    <ul className="d-flex">
                        <li><Link legacyBehavior href="/blog"><a><img src="/images/icons/fb-round.svg" alt=""/></a></Link></li>
                        <li><Link legacyBehavior href="/blog"><a><img src="/images/icons/twitter-round.svg" alt=""/></a></Link></li>
                        <li><Link  legacyBehavior href="/blog"><a><img src="/images/icons/insta-round.svg" alt=""/></a></Link></li>
                    </ul>
                </div>
            </div>
